...
/**
 * 原运装置干化污泥卸输煤记录（卸输煤过磅登记表）
 * 对应中文台账：序号 / 日期 / 车号 / 车型 / 货名 / 发货单位 / 收货单位 /
 *              发运数量(吨) / 实收数量(吨) / 亏吨数量(吨) / 亏吨率(%) /
 *              司磅员 / 卸车地点 / 备注
 */
@Entity({ name: 'dried_sludge_record', comment: '原运装置干化污泥卸输煤记录' })
@Index('idx_dried_sludge_record_date', ['recordDate'])
export class DriedSludgeRecord {
